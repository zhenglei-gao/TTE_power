...
## Scenario 8: Enrollment slower in one arm - increments of 6 month (6 month, 1 year, 1.5 year and 2 years)
...
tte_run_power_analysis (trial_design, n_sim=150, max_events=572, name="scen8a")
