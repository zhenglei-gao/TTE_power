...
## Scenario 7: Drop out high in only TWO active arms 
...
arm_design <- list (
  ...
  "hc1" = tte_arm_design (hazard_event = 0.0525, hazard_dropout = 0.75/1.5, hazard_switch = 0.1/1.5, n_patients=3000, patient_design = pat2),
  "hc2" = tte_arm_design (hazard_event = 0.0525, hazard_dropout = 0.75/1.5, hazard_switch = 0.1/1.5, n_patients=3000, patient_design = pat3),
...
tte_run_power_analysis (trial_design, n_sim=300, max_events=572, name="scen7d")
