...
## Scenario 2c: a 35% dropout rate over 18 months
...
arm_design <- list (
  "control" = tte_arm_design (hazard_event = 0.035, hazard_dropout = 0.35/1.5, hazard_switch = 0.1/1.5, n_patients=3000, patient_design = pat1),
  "hc1" = tte_arm_design (hazard_event = 0.0525, hazard_dropout = 0.35/1.5, hazard_switch = 0.1/1.5, n_patients=3000, patient_design = pat2),
  "hc2" = tte_arm_design (hazard_event = 0.0525, hazard_dropout = 0.35/1.5, hazard_switch = 0.1/1.5, n_patients=3000, patient_design = pat3),
  "hc3" = tte_arm_design (hazard_event = 0.0525, hazard_dropout = 0.35/1.5, hazard_switch = 0.1/1.5, n_patients=3000, patient_design = pat4)
)
...
tte_run_power_analysis (trial_design, n_sim=150, max_events=572, name="scen2c")
